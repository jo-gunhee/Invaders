 ...
 * 
 */
public final class DrawManager extends JFrame {

	public Graphics shipGraphics;
	...
	public DrawManager() {
		...
		try {
			...
			spriteMap.put(SpriteType.SpecialBullet, new boolean[0][0]);
	...
	/**
	 * First part of the drawing process. Initialices buffers, draws the background
	 * and prepares the images.
	 * 
	...
	public void drawEntity(final Entity entity, final int positionX, final int positionY) {
		...
		// System.out.println(entity.getSpriteType().equals(SpriteType.Ship));
		if (entity.getSpriteType() == (SpriteType.Ship)) {
			backBufferGraphics.setColor(Color.orange);
			// int i = 2;
			backBufferGraphics.fillRect(positionX, positionY - 22, 22, 22);

			// left wing front
			backBufferGraphics.clearRect(positionX, positionY - 22, 10, 4);
			backBufferGraphics.clearRect(positionX, positionY - 22, 8, 8);

			// right wing front
			backBufferGraphics.clearRect(positionX + 12, positionY - 22, 10, 4);
			backBufferGraphics.clearRect(positionX + 14, positionY - 22, 8, 8);

			// left wing back
			backBufferGraphics.clearRect(positionX, positionY - 10, 8, 6);
			backBufferGraphics.clearRect(positionX, positionY - 10, 4, 10);

			// right wing back
			backBufferGraphics.clearRect(positionX + 14, positionY - 10, 8, 6);
			backBufferGraphics.clearRect(positionX + 18, positionY - 10, 4, 10);

			// detail
			backBufferGraphics.setColor(Color.BLUE);
			backBufferGraphics.fillRect(positionX + 10, positionY - 18, 2, 4); // handle

			backBufferGraphics.setColor(Color.RED);
			backBufferGraphics.fillRect(positionX + 4, positionY - 16, 2, 2); // left gun
			backBufferGraphics.fillRect(positionX + 16, positionY - 16, 2, 2); // right gun

			backBufferGraphics.clearRect(positionX, positionY - 12, 2, 2); // left wing back
			backBufferGraphics.clearRect(positionX + 20, positionY - 12, 2, 2); // righ wing back

			backBufferGraphics.clearRect(positionX + 4, positionY - 2, 2, 2); // back wing left
			backBufferGraphics.clearRect(positionX + 16, positionY - 2, 2, 2); // back wing right
			backBufferGraphics.clearRect(positionX + 8, positionY - 2, 6, 2); // back wing
			backBufferGraphics.clearRect(positionX + 10, positionY - 4, 2, 4); // back wing

		} else if (entity.getSpriteType() == SpriteType.SpecialBullet) {

			backBufferGraphics.setColor(Color.BLUE);
			backBufferGraphics.fillRect(positionX, positionY - 18, 8, 18);

			// sb left front
			backBufferGraphics.clearRect(positionX, positionY - 18, 4, 2);
			backBufferGraphics.clearRect(positionX, positionY - 18, 2, 4);

			// sb right front
			backBufferGraphics.clearRect(positionX + 6, positionY - 18, 4, 2);
			backBufferGraphics.clearRect(positionX + 8, positionY - 18, 2, 4);

			// sb left back
			backBufferGraphics.clearRect(positionX, positionY - 2, 2, 4);
			backBufferGraphics.clearRect(positionX, positionY, 4, 2);

			// sb right back
			backBufferGraphics.clearRect(positionX + 8, positionY - 2, 2, 4);
			backBufferGraphics.clearRect(positionX + 6, positionY, 4, 2);

			// sb detail
			backBufferGraphics.setColor(Color.RED);
			backBufferGraphics.fillRect(positionX, positionY - 8, 2, 6);
			backBufferGraphics.fillRect(positionX + 2, positionY - 4, 2, 4);
			backBufferGraphics.fillRect(positionX + 4, positionY - 2, 2, 4);
			backBufferGraphics.fillRect(positionX + 6, positionY - 4, 2, 4);
			backBufferGraphics.fillRect(positionX + 8, positionY - 8, 2, 6);

			backBufferGraphics.setColor(Color.ORANGE);
			backBufferGraphics.fillRect(positionX + 2, positionY - 6, 6, 2);
			backBufferGraphics.fillRect(positionX + 4, positionY - 4, 2, 2);
		} else if (entity.getSpriteType() == SpriteType.EnemyBullet) {
			backBufferGraphics.setColor(Color.red);
	...
	public void drawPauseScreen(GameScreen gameScreen, boolean isPaused) {
	}
}
